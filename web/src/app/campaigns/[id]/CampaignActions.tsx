  ...
  return (
    <div className="flex items-center gap-2">
      <button 
        onClick={handleSync}
        disabled={loading}
        className="h-9 px-3.5 bg-white border border-zinc-200 hover:bg-zinc-50 text-zinc-600 rounded-lg text-xs font-medium transition-colors shadow-sm disabled:opacity-50 flex items-center gap-2"
        title="Sync inbox"
      >
      ...
      <button 
        ...
        className="h-9 px-3.5 bg-white border border-zinc-200 hover:bg-zinc-50 text-zinc-600 rounded-lg text-xs font-medium transition-colors shadow-sm flex items-center gap-2"
      >
